...
function AddArray(){
    ...
    return (
        <div className="App">
<h1 style={{"color":"blue"}}>varieties of clothes available only here buy now</h1>
Name:<input type="text" placeholder='enter clothes type' onChange={(vart)=>setType(vart.target.value)}/><br></br>
